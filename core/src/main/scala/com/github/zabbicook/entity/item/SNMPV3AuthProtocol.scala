...
sealed abstract class SNMPV3AuthProtocol(val zabbixValue: IntProp, val desc: String) extends EnumProp2[IntProp]

object SNMPV3AuthProtocol extends IntEnumProp2Companion[SNMPV3AuthProtocol] {
...
sealed abstract class SNMPV3PrivProtocol(val zabbixValue: IntProp, val desc: String) extends EnumProp2[IntProp]

object SNMPV3PrivProtocol extends IntEnumProp2Companion[SNMPV3PrivProtocol] {
...
sealed abstract class SNMPV3SecurityLevel(val zabbixValue: IntProp, val desc: String) extends EnumProp2[IntProp]

object SNMPV3SecurityLevel extends IntEnumProp2Companion[SNMPV3SecurityLevel] {
